...
comments: true
categories: [t1notes]
nb_path: _notebooks/2022-09-25-js-tutorial.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-09-25-js-tutorial.ipynb
-->
...
<div class=" highlight hl-javascript"><pre><span></span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Good afternoon, World!&quot;</span><span class="p">);</span> 
<span class="c1">//python equivalent = print(&quot;insert text here&quot;)</span>
<span class="c1">// console log helps us debug our pages</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-javascript"><pre><span></span><span class="c1">//python equivalent: msg = &quot;Goodnight, World!&quot;;</span>
<span class="kd">var</span> <span class="nx">msg</span> <span class="o">=</span> <span class="s2">&quot;kachow&quot;</span><span class="p">;</span> <span class="c1">//remember to put semicolons!</span>
...
<span class="p">}</span>
<span class="nx">logIt</span><span class="p">(</span><span class="nx">msg</span><span class="p">);</span> <span class="c1">//message becomes the output of the function</span>
<span class="c1">//in jupyter notebooks, you don&#39;t need to re-define the variable, because we ran the cells above that already have the variable &quot;msg&quot; defined</span>
</pre></div>
...
<span class="nx">logIt</span><span class="p">(</span><span class="s2">&quot;Hello, Students!&quot;</span><span class="p">);</span> <span class="c1">//defining logIt</span>
...
<span class="p">}</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s2">&quot;Looking at dynamic nature of output types in JavaScript&quot;</span><span class="p">)</span> <span class="c1">//calling all the logIt types</span>
...
<span class="nx">logItType</span><span class="p">([</span><span class="mf">1</span><span class="p">,</span> <span class="mf">2</span><span class="p">,</span> <span class="mf">3</span><span class="p">]);</span>  <span class="c1">// List -- called an &quot;object&quot; in the output -- Object is generic for this Array, which similar to Python List</span>
<span class="c1">// there are different names for the types of print outputs, like string, number, and object</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Looking at dynamic nature of output types in JavaScript
string ; hello
number ; 2020
object ; [ 1, 2, 3 ]
</pre>
...
<span class="c1">// critical part of every programming language is data</span>
...
<span class="c1">// starting a function called .toJSON</span>
<span class="c1">// JSON is a way for us to share data</span>
...
<span class="kd">var</span> <span class="nx">teacher</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Mrs. Derksen&quot;</span><span class="p">,</span> <span class="s2">&quot;none&quot;</span><span class="p">,</span> <span class="mf">1990</span><span class="p">);</span>
...
<span class="c1">// output of converting the Object and JSON/string associated with Teacher</span>
...
<span class="nx">logItType</span><span class="p">(</span><span class="nx">teacher</span><span class="p">.</span><span class="nx">toJSON</span><span class="p">());</span>  <span class="c1">// json/string is useful when passing data on internet; data shows up as text on the internet</span>
</pre></div>
...
<pre>object ; Person {
  ...
  classOf: 1990,
  role: &#39;Teacher&#39; }
string ; {&#34;name&#34;:&#34;Mrs. Derksen&#34;,&#34;ghID&#34;:&#34;none&#34;,&#34;classOf&#34;:1990,&#34;role&#34;:&#34;Teacher&#34;}
</pre>
</div>
</div>
...
<span class="kd">var</span> <span class="nx">students</span> <span class="o">=</span> <span class="p">[</span> 
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Shreya&quot;</span><span class="p">,</span> <span class="s2">&quot;rey444&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Jiya&quot;</span><span class="p">,</span> <span class="s2">&quot;jiya-sav&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Sanika&quot;</span><span class="p">,</span> <span class="s2">&quot;sanikasha&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Noor&quot;</span><span class="p">,</span> <span class="s2">&quot;Nope1013&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Vaishavi&quot;</span><span class="p">,</span> <span class="s2">&quot;vaishavi-chan&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Rahul&quot;</span><span class="p">,</span> <span class="s2">&quot;protein-shake&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">),</span>
    <span class="k">new</span> <span class="nx">Person</span><span class="p">(</span><span class="s2">&quot;Sohni&quot;</span><span class="p">,</span> <span class="s2">&quot;ok i pull up&quot;</span><span class="p">,</span> <span class="mf">2023</span><span class="p">)</span>
<span class="p">];</span>
...
<pre>object ; [ Person {
    ...
    classOf: 1990,
    role: &#39;Teacher&#39; },
  Person { name: &#39;Shreya&#39;, ghID: &#39;rey444&#39;, classOf: 2023, role: &#39;Student&#39; },
  Person { name: &#39;Jiya&#39;, ghID: &#39;jiya-sav&#39;, classOf: 2023, role: &#39;Student&#39; },
  Person {
    name: &#39;Sanika&#39;,
    ghID: &#39;sanikasha&#39;,
    classOf: 2023,
    role: &#39;Student&#39; },
  Person { name: &#39;Noor&#39;, ghID: &#39;Nope1013&#39;, classOf: 2023, role: &#39;Student&#39; },
  Person {
    name: &#39;Vaishavi&#39;,
    ghID: &#39;vaishavi-chan&#39;,
    classOf: 2023,
...
<span class="c1">// converting the javascript data to HTML for organization is at end, using &quot;$$.html is IJavaScript HTML interpreter&quot;</span>
...
<span class="nx">Classroom</span><span class="p">.</span><span class="nx">prototype</span><span class="p">.</span><span class="nx">_toHtml</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  ...
  <span class="c1">// defining variable &quot;style&quot;</span>
  <span class="kd">var</span> <span class="nx">style</span> <span class="o">=</span> <span class="p">(</span>
    ...
    <span class="s2">&quot;background:MediumPurple;&quot;</span> <span class="o">+</span> <span class="c1">// to change the color, search up &quot;HTML color codes&quot; and type the name of the color you want</span>
    <span class="s2">&quot;border: 8px black;&quot;</span> <span class="o">+</span>
    <span class="s2">&quot;fontcolor: black&quot;</span> <span class="o">+</span>
    <span class="s2">&quot;box-shadow: 0.5em 0.5em 0.4em grey;&quot;</span>
  <span class="p">);</span>

  <span class="c1">// HTML Body of Table is build as a series of concatenations (+=)</span>
  <span class="c1">// concatenations = adding/building stuff</span>
  <span class="kd">var</span> <span class="nx">body</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span><span class="p">;</span> <span class="c1">// using &quot;&quot; to define the variable allows us to have multiple outputs for the variable</span>
  <span class="c1">// Heading for Array Columns</span>
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;tr&gt;&quot;</span><span class="p">;</span> <span class="c1">// tr = table rows</span>
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;th&gt;&lt;mark style=&#39;color: black; background-color:pink&#39;&gt;&quot;</span> <span class="o">+</span> <span class="s2">&quot;Name&quot;</span> <span class="o">+</span> <span class="s2">&quot;&lt;/mark&gt;&lt;/th&gt;&quot;</span><span class="p">;</span> <span class="c1">// th = table headings</span>
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;th&gt;&lt;mark style=&#39;color: black; background-color:pink&#39;&gt;&quot;</span> <span class="o">+</span> <span class="s2">&quot;GitHub ID&quot;</span> <span class="o">+</span> <span class="s2">&quot;&lt;/mark&gt;&lt;/th&gt;&quot;</span><span class="p">;</span>
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;th&gt;&lt;mark style=&#39;color: black; background-color:pink&#39;&gt;&quot;</span> <span class="o">+</span> <span class="s2">&quot;Class Of&quot;</span> <span class="o">+</span> <span class="s2">&quot;&lt;/mark&gt;&lt;/th&gt;&quot;</span><span class="p">;</span>
  <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;th&gt;&lt;mark style=&#39;color: black; background-color:pink&#39;&gt;&quot;</span> <span class="o">+</span> <span class="s2">&quot;Role&quot;</span> <span class="o">+</span> <span class="s2">&quot;&lt;/mark&gt;&lt;/th&gt;&quot;</span><span class="p">;</span>
  ...
  <span class="k">for</span> <span class="p">(</span><span class="kd">var</span> <span class="nx">row</span> <span class="k">of</span> <span class="nx">compsci</span><span class="p">.</span><span class="nx">classroom</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nx">body</span> <span class="o">+=</span> <span class="s2">&quot;&lt;td&gt;&quot;</span> <span class="o">+</span> <span class="nx">row</span><span class="p">.</span><span class="nx">name</span> <span class="o">+</span> <span class="s2">&quot;&lt;/td&gt;&quot;</span><span class="p">;</span> <span class="c1">// td = table data</span>
...
<div style='display:inline-block;background:MediumPurple;border: 8px black;fontcolor: blackbox-shadow: 0.5em 0.5em 0.4em grey;'><table><tr><th><mark>Name</mark></th><th><mark>GitHub ID</mark></th><th><mark>Class Of</mark></th><th><mark>Role</mark></th></tr><tr><td>Mrs. Derksen</td><td>none</td><td>1990</td><td>Teacher</td><tr><tr><td>Shreya</td><td>rey444</td><td>2023</td><td>Student</td><tr><tr><td>Jiya</td><td>jiya-sav</td><td>2023</td><td>Student</td><tr><tr><td>Sanika</td><td>sanikasha</td><td>2023</td><td>Student</td><tr><tr><td>Noor</td><td>Nope1013</td><td>2023</td><td>Student</td><tr><tr><td>Vaishavi</td><td>vaishavi-chan</td><td>2023</td><td>Student</td><tr><tr><td>Rahul</td><td>protein-shake</td><td>2023</td><td>Student</td><tr><tr><td>Sohni</td><td>ok i pull up</td><td>2023</td><td>Student</td><tr></table></div>
</div>
