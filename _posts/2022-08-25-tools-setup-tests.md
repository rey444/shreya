---
keywords: fastai
description: Ensuring all the necessary tools are installed on my machine.
...
comments: true
categories: [tri1]
nb_path: _notebooks/2022-08-25-tools-setup-tests.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-08-25-tools-setup-tests.ipynb
-->
...
<div class="output_subarea output_stream output_stdout output_text">
<pre># packages in environment at /home/shreyasapkal/anaconda3:
#
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-python"><pre><span></span><span class="n">echo</span> <span class="n">Conda</span> <span class="n">Check</span> <span class="c1">#  for jupyter kernel installation</span>
...
<span class="n">n</span><span class="o">=</span><span class="err">$</span><span class="p">{</span><span class="c1">#check} # determine length of test</span>

<span class="k">if</span> <span class="p">[[</span> <span class="err">$</span><span class="p">{</span><span class="n">n</span><span class="p">}</span> <span class="o">&gt;</span> <span class="mi">0</span> <span class="p">]];</span>  <span class="c1"># define value of test length, begin while-if-else loop</span>
<span class="n">then</span> <span class="c1"># if the test legnth is greater than zero</span>
    <span class="n">echo</span> <span class="s2">&quot;$check&quot;</span> <span class="c1"># confirmation message</span>
<span class="k">else</span> <span class="c1"># if the test length is less than zero</span>
    <span class="n">echo</span> <span class="s2">&quot;$test not found&quot;</span> <span class="c1">#error message</span>
<span class="n">fi</span> <span class="c1"># end while-if-else loop</span>
</pre></div>
...
traitlets        : 5.3.0
Available kernels:
  bash          /home/shreyasapkal/.local/share/jupyter/kernels/bash
  javascript    /home/shreyasapkal/.local/share/jupyter/kernels/javascript
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Python3-Check">Python3 Check<a class="anchor-link" href="#Python3-Check"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>  python3       /home/shreyasapkal/.local/share/jupyter/kernels/python3
</pre>
</div>
</div>
